  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-2/3 lg:w-1/2">
        <h2 className="text-2xl font-bold text-center mb-6">School Student Registration</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4">
            <label htmlFor="schoolIdUpload" className="block text-gray-600 font-semibold">School ID Upload</label>
            <input type="file" name="schoolIdUpload" onChange={handleChange} className="form-input" />
          </div>
